...
module.exports = {
    sendToSlack: (req, res) => {
        ...
        const twiml = [{ Response: '<?xml version="1.0" encoding="UTF-8" ?><Response><Message>You were correct. We\'ll be sending out messages to the first 5 partisipants soon.</Message></Response>' }];
        res.end(xml(twiml));
    },
};